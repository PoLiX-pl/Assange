...
TODO: consider http://theindicter.com/new-analysis-of-swedish-police-report-confirms-julian-assanges-version-in-swedens-case/ and Head of Swedish Bar Association condemns the handling of the Assange case in the UK and Sweden as deplorable: http://the-pen.co/reputation-of-swedish-judicial-system-damaged/
